...
It can also hide adult spam, bait bots, and ads, with strength, an allowlist, and your own block words. There's a download button for images, videos, and GIFs, packed as ZIP when there's more than one. Multi-image posts can use a grid, and age covers come off on this page only — it doesn't change your X settings. Open **Settings** from the userscript menu.
